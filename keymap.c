 ...
 * |   A  |   S  |   D  |   F  |   G  |   H  |   J  |   K  |   L  |   ;  |
 * |------+------+------+------+-------------+------+------+------+------|
 * | Shift|  Alt |  GUI | Funct| Lower| Raise| Arrow|  GUI |  Alt | Shift|
...
[_QWERTY] = KEYMAP( \
  ...
  LT(_RAISE, KC_BSPC), LT(_ARROW, KC_B), GUI_T(KC_N), ALT_T(KC_M), SFT_T(KC_ENT) \
),
[_RQWERTY] = RKEYMAP( \
  TD(TD_Q_TAB), KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, \
  CTL_T(KC_A), KC_S, KC_D, KC_F, KC_G, \
  ...
  LT(_RRAISE, KC_BSPC), LT(_RARROW, KC_B), GUI_T(KC_N), ALT_T(KC_M), SFT_T(KC_ENT) \
),
 ...
 * |      |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+-------------+------+------+------+------|
 * |      |      |BACKLI|XXXXXX|      |      |      |      |      |XXXXXX|
 * |BL_TOG|BACKLI|BREATH|XXXXXX|      |      |      |      |      |XXXXXX|
 * `---------------------------------------------------------------------'
 */
[_ADMINI] = KEYMAP( \
  RESET, _______, _______, _______, _______, _______, _______, _______, IJIDEA, RQWERTY, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  BL_TOGG, BACKLIT, BL_BRTG, _______, _______, _______, _______, _______, _______, _______ \
),
[_RADMINI] = RKEYMAP( \
